...
public class Application {
    ...
    @Bean
    public CommandLineRunner demo(UserRepository userRepository, GameRepository gameRepository, GameBoardRepository gameBoardRepository, AuthenticationService authentication, Utilities utils) {
        return (args) -> {
            ...
            GameService gameService = new GameService(gameRepository, gameBoardRepository, userRepository,userService);
            // save a few games
